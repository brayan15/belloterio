...
describe('Reducer', () => {
  ...
  test('Should handle GET_CALCULATOR_INFO', () => {
    const EXPECTED_STATE = { configInfo: { title: 'title', description: 'description' } }
    const DISPATCHED_ACTION = { type: GET_CALCULATOR_INFO, payload: { title: 'title', description: 'description' } }
